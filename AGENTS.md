...
- Stack: Next.js 16 (Turbopack) + React 19, styled with Tailwind CSS 4. Verified on Node 24 (`nvm install 24 && nvm alias default 24`). No `NODE_OPTIONS=--openssl-legacy-provider` is needed.
