 ...
 * Home page component.
 *
 * `users` is loaded on the server and passed in as a prop before render.
 * - Docker / Cursor: getServerSideProps fetches live data from Postgres
 * - GitHub Pages: getStaticProps returns an explanation (no database on static hosting)
 */
const Home = ({ users = [], usersUnavailableReason = null }) => {
